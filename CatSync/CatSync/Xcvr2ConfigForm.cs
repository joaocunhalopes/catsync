namespace CatSync
{
    public partial class Xcvr2ConfigForm : Form
    {
        public Xcvr2ConfigForm()
        {
            InitializeComponent();
        ...
        {
            PopulateComboBox();
            SetXcvrValues(Xcvr.Control.Xcvrs[1]);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                Xcvr.Control.CloseXcvrPort(Xcvr.Control.Xcvrs[1]);
                UpdateXcvrValues(Xcvr.Control.Xcvrs[1]);
